...
public class LoginPanelController  {
    ...
    @FXML
        private void handleButtonAction(ActionEvent event) {
            ...
            if (event.getSource().equals(btnSignIn)) {
                ...
                LoginData loginData = new LoginData(em, ps);
                ServerResponse serverResponse = RequestSender.sendRequest(new ClientRequest("login", loginData));
                User authenticatedUser = (User) serverResponse.getData();
                try {
    ...
    private void registerUser() {
        ...
        if(nickname != null && email != null && pass != null && age != null && bal != null) {
            ...
            System.out.println("PROSZE UZUPELNIC WSZYSTKIE POLA!");
        }
